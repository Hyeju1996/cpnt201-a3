...
test('set this', function _callee8(t) {
...
test('unshift', function _callee9(t) {
...
test('push with worker throwing error', function _callee11(t) {
  var q;
  return regeneratorRuntime.async(function _callee11$(_context20) {
    while (1) {
      switch (_context20.prev = _context20.next) {
        case 0:
          t.plan(5);
          q = buildQueue(function _callee10(task, cb) {
        ...
        case 8:
          ...
          t.ok(_context20.t0 instanceof Error, 'push callback should catch the error');
          t.match(_context20.t0.message, /test error/, 'error message should be "test error"');
...
test('unshift with worker throwing error', function _callee13(t) {
  var q;
    ...
    while (1) {
      switch (_context22.prev = _context22.next) {
        ...
        case 7:
          ...
          t.ok(_context22.t0 instanceof Error, 'push callback should catch the error');
          t.match(_context22.t0.message, /test error/, 'error message should be "test error"');
...
test('no unhandledRejection (unshift)', function _callee17(t) {
  var handleRejection, q;
  return regeneratorRuntime.async(function _callee17$(_context26) {
    while (1) {
      switch (_context26.prev = _context26.next) {
        case 0:
          handleRejection = function _ref12() {
            t.fail('unhandledRejection');
          };
