...
function detectLockfile() {
  ...
  if (!packageDir) {
    throw new BrowserslistError('Cannot find package.json. ' + 'Is this the right directory to run `npx browserslist --update-db` in?');
  }
...
module.exports = function updateDB(print) {
  ...
  if (browsersListRetrievalError) {
    ...
    var targetBrowserChanges = diffBrowsersLists(oldBrowsersList, currentBrowsersList);
