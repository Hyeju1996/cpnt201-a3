...
function getDefaultSearchPlaces(name) {
  return ['package.json', ".".concat(name, "rc.json"), ".".concat(name, "rc.js"), "".concat(name, ".config.js"), ".".concat(name, "rc.cjs"), "".concat(name, ".config.cjs")];
}
...
function getSearchItems(searchPlaces, searchPaths) {
  return searchPaths.reduce(function (acc, searchPath) {
    searchPlaces.forEach(function (fileName) {
      return acc.push({
        fileName: fileName,
...
function lilconfig(name, options) {
  ...
  return {
    search: function search() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 9:
              ...
              _step$value = _step.value, fileName = _step$value.fileName, filepath = _step$value.filepath, loaderKey = _step$value.loaderKey;
              _context.prev = 11;
              _context.next = 14;
      ...
      }, null, null, [[7, 44, 48, 56], [11, 16], [49,, 51, 55]]);
    },
