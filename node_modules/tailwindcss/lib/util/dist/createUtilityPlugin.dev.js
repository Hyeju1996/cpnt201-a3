  ...
  return function (_ref2) {
    ...
    try {
      for (var _iterator = utilityVariations[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        var ref;
        matchUtilities(group.reduce(function (obj1, _ref3) {
          var _ref4 = _slicedToArray(_ref3, 2),
              classPrefix = _ref4[0],
              properties = _ref4[1];

          return Object.assign(obj1, _defineProperty({}, classPrefix, function (value) {
          ...
          values: filterDefault ? Object.fromEntries(Object.entries((ref = theme(themeKey)) !== null && ref !== void 0 ? ref : {}).filter(function (_ref5) {
