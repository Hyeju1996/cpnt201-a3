...
(function (root) {
  ...
  if (!BigInt) BigInt = function BigInt(n) {
    return n;
  };
  var C_ONE = BigInt(1);
  var C_ZERO = BigInt(0);
  var C_TEN = BigInt(10);
  var C_TWO = BigInt(2);
  var C_FIVE = BigInt(5); // Maximum search depth for cyclic rational numbers. 2000 should be more than enough.
  // Example: 1/7 = 0.(142857) has 6 repeating decimal places.
  // If MAX_CYCLE_LEN gets reduced, long cycles will not be detected and toString() only gets the first 10 digits

  var MAX_CYCLE_LEN = BigInt(2000); // Parsed data to avoid calling "new" all the time
    ...
    if (p1 === undefined || p1 === null) {
      ...
      if (match.length === ndx + 1) {
        ...
        if (match[ndx] === '(' && match[ndx + 2] === ')' || match[ndx] === "'" && match[ndx + 2] === "'") {
          ...
          _z = Math.pow(C_TEN, BigInt(match[ndx + 1].length)) - C_ONE;
          ndx += 3;
        }
  ...
  Fraction.prototype = {
    ...
    "ceil": function ceil(places) {
      places = Math.pow(C_TEN, BigInt(places || 0));
      return new Fraction(this["s"] * places * this["n"] / this["d"] + (places * this["n"] % this["d"] > C_ZERO && this["s"] >= C_ZERO ? C_ONE : C_ZERO), places);
    },
    ...
    "round": function round(places) {
      ...
      */
      ...
      return new Fraction(this["s"] * places * this["n"] / this["d"] + this["s"] * ((this["s"] >= C_ZERO ? C_ONE : C_ZERO) + C_TWO * (places * this["n"] % this["d"]) > this["d"] ? C_ONE : C_ZERO), places);
    },
    ...
    'toString': function toString(dec) {
      ...
      var str = this['s'] < C_ZERO ? "-" : ""; // Append integer part
    ...
    'toFraction': function toFraction(excludeWhole) {
      var n = this["n"];
      var d = this["d"];
      var str = this['s'] < C_ZERO ? "-" : "";

      if (d === C_ONE) {
        str += n;
      } else {
        var whole = n / d | C_ZERO;
